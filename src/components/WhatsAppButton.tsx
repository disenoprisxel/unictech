...
export default function WhatsAppButton() {
  ...
  return (
    <div style={{ position: 'fixed', bottom: '24px', right: '24px', zIndex: 1000, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '12px' }}>
      ...
      {/* ── Floating button + ripples ── */}
      <div style={{ position: 'relative', width: '56px', height: '56px' }}>

        {/* Ripple rings — only when popup is closed */}
        {!open && (
          <>
            <span className="wa-ripple wa-ripple-1" />
        ...
        <button
          ...
          style={{
            ...
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            boxShadow: '0 4px 24px rgba(37,211,102,0.50)',
      ...
      <style>{`
        ...
        /* Subtle bounce on the button icon */
        .wa-bounce {
        ...
        .wa-bounce:hover {
          ...
          box-shadow: 0 6px 32px rgba(37,211,102,0.70) !important;
        }
      `}</style>
    </div>
  );
