    ...
    <>
      ...
      <section className="py-16 px-6" style={{ backgroundColor: '#f0f0f0' }}>
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <p
              className="text-[13px] font-bold uppercase tracking-[3px] mb-3"
              style={{ color: ACCENT }}
            >
              ¿QUIENES SOMOS?
            </p>
            ...
            <p className="text-gray-800 leading-relaxed text-[16px] text-justify mb-6 font-normal">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {practicas.map((p, i) => (
              ...
              >
                ...
                <p className="text-[15px] font-bold text-gray-800 leading-snug">{p.label}</p>
              </div>
            ))}
          </div>
        </div>
